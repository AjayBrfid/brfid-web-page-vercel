...
const VERTICALS = [
  {
    id: 'textile', label: 'Textile & Garments', color: '#34ACE0',
    ...
    useCases: ['Item-level source tagging at point of manufacture', 'Automated warehouse receiving via fixed RFID portals', 'Store-level cycle counts completed in hours, not days', 'EAS-integrated loss prevention at exit points', 'Omnichannel BOPIS fulfilment with live stock confirmation', 'Returns processing with automatic restock and condition tagging'],
    features: [
      { label: 'Live SKU dashboard', desc: 'Real-time visibility across all warehouse and store locations' },
      { label: 'Handheld scanning app', desc: 'iOS and Android for in-aisle cycle counts and receiving' },
      { label: 'ERP & WMS integration', desc: 'Native connectors for SAP, Oracle, and Microsoft Dynamics' },
      { label: 'EAS deactivation at POS', desc: 'Simultaneous payment processing and tag deactivation' },
      { label: 'Replenishment alerts', desc: 'Auto-trigger restocking when SKU falls below threshold' },
    ],
    outcomes: [{ metric: '99.9%', label: 'Inventory accuracy' }, { metric: '75%', label: 'Faster cycle counts' }, { metric: '<0.5%', label: 'Shrinkage rate' }],
  },
  {
    id: 'medical', label: 'Medical & Healthcare', color: '#AB3480',
    ...
    useCases: ['Autoclave-safe RFID tagging for surgical instrument sets', 'Patient wristband scanning for positive ID at every touchpoint', 'Blood bag tracking from donation to transfusion', 'Real-time location of mobile medical equipment across the facility', 'Automated sterilization cycle verification and digital logging'],
    features: [
      ...
      { label: 'Patient wristband scanning', desc: 'Positive patient ID at medication and procedure points' },
    ],
    outcomes: [{ metric: '0', label: 'Miscount incidents' }, { metric: '40%', label: 'Less search time' }, { metric: '100%', label: 'Sterilization traceability' }],
  },
  {
    id: 'agriculture', label: 'Agriculture', color: '#7CB518',
    ...
    useCases: ['RFID ear-tag based livestock identification and movement logging', 'Harvest lot traceability tied to field, date, and operator', 'Cold-chain temperature monitoring from packhouse to distributor', 'Farm equipment location audit and utilisation tracking', 'Automated regulatory compliance report generation'],
    features: [
      { label: 'Offline-capable mobile app', desc: 'Stores data without connectivity and syncs instantly on reconnect' },
      { label: 'Herd health history', desc: 'Individual animal records: vaccinations, weight, and movements' },
    ...
    outcomes: [{ metric: '100%', label: 'Herd visibility' }, { metric: 'Full', label: 'Farm-to-fork trace' }, { metric: 'Auto', label: 'Compliance reports' }],
  },
  {
    id: 'logistics', label: 'Transport & Logistics', color: '#34ACE0',
    ...
    useCases: ['Pallet-level RFID tagging at point of palletisation', 'Dock-door portal scanning for instant inbound and outbound confirmation', 'Load plan versus actual comparison before truck seal', 'Parcel-level sortation in high-throughput distribution centres', 'Cross-dock operations with zero manual scan intervention', 'Real-time trailer and container location tracking across depot and yard operations'],
    features: [
      ...
      { label: 'Customer tracking portal', desc: 'White-labelled self-service shipment visibility for clients' },
    ],
    outcomes: [{ metric: '99.8%', label: 'Load accuracy' }, { metric: '60%', label: 'Faster dock processing' }, { metric: 'Live', label: 'SLA management' }],
  },
  {
    id: 'asset', label: 'Asset Management', color: '#AB3480',
    ...
    useCases: ['IT asset tagging for laptops, monitors, and networking hardware', 'Furniture and fixtures inventory across multi-site organisations', 'Tool crib management with check-in and check-out accountability', 'Field equipment dispatch tracking and return verification', 'GPS-stamped compliance audits for insurance and ISO certification'],
    features: [
      { label: 'Live asset register', desc: 'Single source of truth updated in real time across all sites' },
      { label: 'Ghost asset identification', desc: 'Flags assets on the books absent from physical scan' },
      { label: 'Tool crib kiosk', desc: 'Self-service RFID check-in and check-out, no supervisor needed' },
      { label: 'Depreciation sync', desc: 'Push verified asset data directly to your ERP fixed-asset module' },
      { label: 'Audit report export', desc: 'One-click export of audit-ready register with location timestamps' },
    ],
    outcomes: [{ metric: '0', label: 'Ghost assets' }, { metric: '80%', label: 'Faster audits' }, { metric: '100%', label: 'Chain of custody' }],
  },
  {
    id: 'food', label: 'Food Industry', color: '#E07C34',
    ...
    useCases: ['Lot-level RFID tagging at point of processing or packing', 'Warehouse picking guided by FEFO to minimise waste', 'Cold-chain pallet monitoring from chiller to delivery dock', 'Processor-to-shelf traceability for fresh and ambient SKUs', 'Instant batch recall execution with precise lot-level targeting', 'Automated expiry monitoring with system-triggered quarantine for at-risk batches'],
    features: [
      ...
      { label: 'Shelf-life dashboard', desc: 'Live view of remaining shelf life per SKU per location' },
      { label: 'Batch recall execution', desc: 'Identify, quarantine, and notify on affected lots in minutes' },
    ],
    outcomes: [{ metric: 'FSMA', label: '204 compliant' }, { metric: '<60s', label: 'Breach alerts' }, { metric: 'Hours', label: 'Not days for recalls' }],
  },
  {
    id: 'dairy', label: 'Dairy', color: '#34ACE0',
    ...
    useCases: ['Product-level RFID tagging at the processing plant', 'FEFO-enforced dispatch for short shelf-life SKUs', 'Cold-chain temperature monitoring across the distribution network', 'Retail shelf freshness monitoring with early-warning alerts', 'Consumer-facing QR scan for origin and batch traceability', 'Milk tanker journey tracking from farm collection point to processing facility'],
    features: [
      ...
      { label: 'Shelf-life dashboard', desc: 'Distributor and retailer visibility of remaining shelf life per pallet' },
      { label: 'FSSAI compliance records', desc: 'Automated digital records aligned with FSSAI traceability requirements' },
      { label: 'Consumer QR traceability', desc: 'Scan-to-origin: farm, processing plant, batch, and date' },
    ],
    outcomes: [{ metric: '0', label: 'FEFO violations' }, { metric: '60s', label: 'Cold-chain alerts' }, { metric: 'End-to-end', label: 'Traceability' }],
  },
  {
    id: 'retail', label: 'Retail & Shopping', color: '#AB3480',
    ...
    useCases: ['Source-tagged RFID from supplier with no in-store tagging labour', 'Automated store-level cycle counts without closing the floor', 'Smart fitting rooms with item-level interaction logging', 'EAS exit portal for loss prevention integrated with POS', 'Planogram compliance verification via handheld scan', 'Click-and-collect order verification with RFID-confirmed pick accuracy'],
    features: [
      { label: 'Real-time inventory dashboard', desc: 'Per-SKU, per-location stock truth updated every scan cycle' },
      { label: 'Self-checkout under 3 seconds', desc: 'Basket-read RFID checkout — no barcode scanning required' },
      ...
      { label: 'Omnichannel stock accuracy', desc: 'Unified inventory across in-store, online, and BOPIS channels' },
    ],
    outcomes: [{ metric: '98%+', label: 'Inventory accuracy' }, { metric: '<3s', label: 'Self-checkout' }, { metric: 'Proven', label: 'Shrinkage reduction' }],
  },
  {
    id: 'ticketing', label: 'Ticketing & Venue', color: '#7CB518',
    ...
    useCases: ['RFID wristband issuance and personalisation at registration', 'Rapid gate entry processing at 30+ scans per minute per lane', 'Cashless payment at all food, beverage, and merchandise points', 'Zone-based VIP and backstage access control with anti-passback', 'Live crowd density monitoring for venue safety management', 'Multi-day re-entry management with session-based access rules per wristband'],
    features: [
      { label: 'Rolling cryptographic codes', desc: 'Anti-cloning wristband security — each read rotates the credential' },
    ...
    outcomes: [{ metric: '30+', label: 'Entries per minute' }, { metric: '100%', label: 'Cashless operations' }, { metric: 'Real-time', label: 'Safety intelligence' }],
  },
]
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <h1 className={styles.heroTitle}>
          Purpose-Built for <span className={styles.heroAccent}>Every Industry</span>
        </h1>
        <p className={styles.heroSub}>
          Select your industry to explore how Britannia RFID delivers measurable results.
        </p>
      </section>
      ...
      <div className={styles.layout}>
        ...
        <aside className={styles.sidebar}>
          ...
          {VERTICALS.map((vt, i) => (
            <button
              ...
              style={i === active ? { borderLeftColor: vt.color, background: `${vt.color}12` } : {}}
              onClick={() => setActive(i)}
            >
              <span className={styles.sideIcon} style={i === active ? { background: `${vt.color}20`, color: vt.color } : {}}>
                {ICONS[vt.id]}
              </span>
        ...
        <main className={styles.main}>
          <div key={active} className={styles.panel} style={{ borderTopColor: v.color }}>

            {/* Panel header */}
            <div className={styles.panelHead}>
              <div className={styles.panelIdent}>
                <span className={styles.panelIcon} style={{ background: `${v.color}18`, color: v.color }}>
                  {ICONS[v.id]}
                </span>
                <div>
            ...
            {/* Outcomes band — full width */}
            <div className={styles.outcomesBand}>
              <span className={styles.outcomesLabel}>Proven Outcomes</span>
              <div className={styles.metricsRow}>
                {v.outcomes.map((o, i) => (
                  <div key={i} className={styles.metricPill} style={{ borderLeftColor: v.color }}>
                    <span className={styles.metricVal} style={{ color: v.color }}>{o.metric}</span>
      ...
      <section className={styles.bottomCta}>
        ...
        <p className={styles.bottomCtaSub}>Talk to a solutions specialist and get a deployment plan tailored to your industry.</p>
        <button className={styles.ctaBtn} style={{ background: '#34ACE0', padding: '0.85rem 2.5rem', fontSize: '0.9rem' }} onClick={() => navigate('/contact')}>
          Get Started
        </button>
      </section>
